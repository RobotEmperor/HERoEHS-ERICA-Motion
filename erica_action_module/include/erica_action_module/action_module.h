...
#ifndef ERICA_ACTION_MODULE_ACTION_MODULE_H_
#define ERICA_ACTION_MODULE_ACTION_MODULE_H_
...
#include "erica_action_module_msgs/IsRunning.h"
#include "erica_action_module_msgs/StartAction.h"
...
private:
  ...
  bool isRunningServiceCallback(erica_action_module_msgs::IsRunning::Request  &req,
                                erica_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr& msg);
  void startActionCallback(const erica_action_module_msgs::StartAction::ConstPtr& msg);
...
#endif /* ERICA_ACTION_MODULE_ACTION_MODULE_H_ */
