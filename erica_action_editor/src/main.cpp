...
{
  ros::init(argc, argv, "ERICA Action Editor");
  ros::NodeHandle nh;
...
//          }
          ...
          {
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0], erica_alice::ActionEditor::RightToLeft,
                  erica_alice::ActionEditor::UpperBody);
            else
              editor.printCmd("Need parameter");
          }
...
//          }
          ...
          {
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0], erica_alice::ActionEditor::LeftToRight,
                  erica_alice::ActionEditor::UpperBody);
            else
              editor.printCmd("Need parameter");
          }
